  ...
  <Deck theme={theme} template={template}>
    ...
    <Slide backgroundColor="background">
      ...
      <UnorderedList style={{ fontSize: 28 }}>
        ...
        <ListItem>Подальший розвиток цього проєкту відбуватиметься завдяки підтримці зацікавлених осіб</ListItem>
        <ListItem>Маркетинг же надзвичайно простий - ми ділитимемось фотографіями і даними про нашу ОС на соцмережі Reddit</ListItem>
    ...
    <Slide backgroundColor="background">
      ...
      <Text>
        Термін ricing походить зі світу автомобілів.
